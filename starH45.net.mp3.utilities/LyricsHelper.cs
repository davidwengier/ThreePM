...
namespace starH45.net.mp3.utilities
{
	public class LyricsHelper
	{
		...
		public static string GetSongTitleRegex(starH45.net.mp3.player.SongInfo song)
		{
			/*
		...
		private starH45.net.mp3.player.SongInfo m_song;
		...
		public starH45.net.mp3.player.SongInfo Song
		{
			get
			{
				return m_song;
		...
		public LyricsHelper(library.Library library)
		{
			m_library = library;
		...
		public void LoadLyrics(starH45.net.mp3.player.SongInfo song)
		{
			LoadLyrics(song, false, false, false);
		}

		public void LoadLyrics(starH45.net.mp3.player.SongInfo song, bool skipTextFile, bool onlyTextFile, bool skipOtherSongsInDatabase)
		{
		...
		public static void SaveLyricsFile(starH45.net.mp3.player.SongInfo song, string lyrics)
		{
