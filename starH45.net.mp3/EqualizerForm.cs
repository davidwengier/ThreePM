	...
	public partial class EqualizerForm : BaseForm
	{
		...
		protected override void InitPlayer()
		{
			foreach (Control c in this.Controls)
			{
				...
				if (tck != null)
				{
					tck.SetPosition(Convert.ToSingle(Utilities.GetValue("EqualizerForm." +tck.Name +".Value", Player.GetEqualizerPosition(Convert.ToInt32(tck.Name.Substring(3))).ToString())) + 15);
				}
			}
		}
		...
		private void tck_Changing(object sender, EventArgs e)
		{
			...
			Utilities.SetValue("EqualizerForm." + tck.Name + ".Value", Player.GetEqualizerPosition(Convert.ToInt32(tck.Name.Substring(3))).ToString());
		}
