...
namespace starH45.net.mp3
{
	partial class LibraryForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.playlistControl = new starH45.net.mp3.ui.PlaylistControl();
			this.searchControl = new starH45.net.mp3.ui.SearchControl();
			this.infoControl = new starH45.net.mp3.ui.InfoControl();
			this.splitContainer = new System.Windows.Forms.SplitContainer();
			this.lblLoading = new System.Windows.Forms.Label();
			this.statisticsControl = new starH45.net.mp3.ui.StatisticsControl();
			this.songListView = new starH45.net.mp3.ui.SongListView();
