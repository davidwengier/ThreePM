...
namespace ThreePM
{
    public partial class OptionsForm : BaseForm
    {
        ...
        public OptionsForm()
        {
            ...
            cboVisualization.SelectedIndex = _frmMain.VisualizationNumber;
            chkHighQuality.Checked = _frmMain.VisualizationHighQuality;
            chkFullSpectrum.Checked = _frmMain.VisualizationFullSpectrum;
            txtVisualizationSpeed.Text = _frmMain.VisualizationSpeed.ToString();

            chkToaster.Checked = _frmMain.ShowToasterForm;
        ...
        protected override void InitLibrary()
        {
            ...
            foreach (string dir in this.Library.GetWatchFolders())
            {
                lstWatchFolders.Items.Add(dir);
            }

            lstRadio.Items.Clear();
            foreach (ThreePM.MusicLibrary.LibraryEntry entry in this.Library.GetInternetRadios())
            {
        ...
        protected override void InitPlayer()
        {
            ...
            _initialising = true;
            cboDevice.SelectedIndex = this.Player.DeviceNumber;
            _initialising = false;
        }
        ...
        private void btnAdd_Click(object sender, System.EventArgs e)
        {
            ...
            if (dlg.ShowDialog(this) == DialogResult.OK)
            {
                ...
                this.Library.AddWatchFolder(dlg.SelectedPath);
            }
        }
        ...
        private void btnRemove_Click(object sender, System.EventArgs e)
        {
            ...
            this.Library.RemoveWatchFolder(dir);
        }
        ...
        {
            if (_initialising) return;
            this.Player.DeviceNumber = cboDevice.SelectedIndex;
        }

        private void cboVisualization_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (_initialising) return;
            _frmMain.VisualizationNumber = cboVisualization.SelectedIndex;
        }
        ...
        {
            if (_initialising) return;
            _frmMain.VisualizationHighQuality = chkHighQuality.Checked;
        }
        ...
        {
            if (_initialising) return;
            _frmMain.VisualizationFullSpectrum = chkFullSpectrum.Checked;
        }

        private void chkToaster_CheckedChanged(object sender, EventArgs e)
        {
            if (_initialising) return;
            _frmMain.ShowToasterForm = chkToaster.Checked;
        }
        ...
        private void btnClearPlayCount_Click(object sender, EventArgs e)
        {
            ...
            this.Library.ClearAllPlayCounts();
        }

        private void btnClearDateAdded_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure?\n\n" + (sender as Button).Tag.ToString(), "Are you sure?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No) return;
            this.Library.ClearAllDateAddeds();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure?\n\n" + (sender as Button).Tag.ToString(), "Are you sure?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No) return;
            this.Player.Playlist.Clear();
            this.Player.Playlist.AddToEnd(this.Library.QueryLibrary(@"Lyrics ISNULL OR Lyrics = ''"));
        }
        ...
        private void btnSaveLyrics_Click(object sender, EventArgs e)
        {
            ...
            ThreePM.MusicLibrary.LibraryEntry[] entries = this.Library.QueryLibrary("Lyrics <> '' AND Lyrics IS NOT NULL");
        ...
        private void btnRadioAdd_Click(object sender, EventArgs e)
        {
            ...
            this.Library.AddInternetRadio(txtRadio.Text);
        }
        ...
        private void btnRadioDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Library.DeleteInternetRadio(lstRadio.Text);
            }
        }
    }
}
