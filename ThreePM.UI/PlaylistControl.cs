	...
	public partial class PlaylistControl : UserControl
	{
		...
		private void btnPlaylistStyle_Click(object sender, EventArgs e)
		{
			switch (Player.Playlist.PlaylistStyle)
			{
				case ThreePM.MusicPlayer.PlaylistStyle.Normal:
				{
					Player.Playlist.PlaylistStyle = ThreePM.MusicPlayer.PlaylistStyle.Random;
					break;
				}
				case ThreePM.MusicPlayer.PlaylistStyle.Random:
				{
					Player.Playlist.PlaylistStyle = ThreePM.MusicPlayer.PlaylistStyle.Looping;
					break;
				}
				case ThreePM.MusicPlayer.PlaylistStyle.Looping:
				{
					Player.Playlist.PlaylistStyle = ThreePM.MusicPlayer.PlaylistStyle.RandomLooping;
					break;
				}
				case ThreePM.MusicPlayer.PlaylistStyle.RandomLooping:
				{
					Player.Playlist.PlaylistStyle = ThreePM.MusicPlayer.PlaylistStyle.Normal;
					break;
				}
			}
		}
		...
		private void songListView_DoubleClick(object sender, EventArgs e)
		{
			...
			if (Player.Playlist.PlaylistStyle == ThreePM.MusicPlayer.PlaylistStyle.Normal || Player.Playlist.PlaylistStyle == ThreePM.MusicPlayer.PlaylistStyle.Random)
			{
				btnRemove.PerformClick();
			}
			else if (Player.Playlist.PlaylistStyle == ThreePM.MusicPlayer.PlaylistStyle.Looping)
			{
